...
<body>
  ...
  <div class="dashboard-layout">
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-item menu-booking" onclick="showSection('booking',this)">
        ...
        <span class="menu-title">Booking Masuk</span>
          ...
          <div class="stat-card">
            <div class="row-between">
              <div>
                ...
                <div class="stat-value" id="dashboard-aktif">
            ...
            <div class="stat-change" id="dashboard-aktif-text" style="color:var(--gray-400);">
        ...
        <div class="grid-2col">
          <div class="revenue-card">
            ...
            <div class="progress-bar progress-bar-inner">
              <div class="progress-fill" style="width: <?= round($persenTarget, 1); ?>%;">
              </div>
            </div>
                  ...
                  foreach ($booking7Hari as $index => $jumlah) {
                    ...
                    <div class="chart-bar-col">
                      <div class="chart-bar-area">
                        ...
                        <div class="chart-bar <?= $index == $hariIni ? 'active' : ''; ?>" style="height:<?= $tinggi ?>%">
                        </div>

                      </div>

                      <div class="chart-bar-label" <?= $index == $hariIni ? 'style="color:var(--green);font-weight:700;"' : ''; ?>>
                        <?= $label ?>
                      </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="dashboard-actions">
                          <a href="update-booking-status.php?id=<?= $row['booking_id']; ?>&status=terkonfirmasi"
                            class="btn btn-primary btn-sm" onclick="return confirm('Konfirmasi booking ini?');">
                            <i class="ti ti-check"></i>
                            Konfirmasi
                          </a>

                          <a href="update-booking-status.php?id=<?= $row['booking_id']; ?>&status=dibatalkan"
    ...
    <div class="search-box">
            ...
            data-type="<?= strtolower(trim($field['jenis'])); ?>">
              <div class="field-image">
                ...
                if (!empty($field['gambar']) && file_exists($gambar)) {
                  ...
                  <img src="<?= $gambar; ?>" alt="<?= $field['nama_lapangan']; ?>">
              ...
              <div class="field-status">
                ...
                <?php } elseif ($field['verifikasi'] == 'diterima') { ?>
                  ...
                  <div class="booking-status">
                    ...
                    <span
                      class="booking-badge <?= strtolower($field['status']) == 'tersedia' ? 'badge-green' : 'badge-red'; ?>">
                  ...
                  <div class="lapangan-status">
                    ...
                    <span id="status-text-<?= $field['field_id']; ?>"
              ...
              <div class="field-btns">
                ...
                <?php if ($field['verifikasi'] == 'diterima') { ?>
                  ...
                  <label class="switch">
                    <input type="checkbox" <?= $field['aktif'] == 'aktif' ? 'checked' : ''; ?>
                ...
                <button class="btn btn-outline btn-sm btn-red" onclick="hapusLapangan(
                    <?= $field['field_id']; ?>,
                    '<?= addslashes($field['nama_lapangan']); ?>'
                )">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;margin-top:20px;">
          ...
          <div class="stat-card" style="padding:14px;">
            ...
            <div id="aktif-count" class="mini-stat-val" style="font-size:28px;color:var(--green);">
              <?= $dataAktif['total']; ?>
            </div>
          </div>
          ...
          <div class="stat-card" style="padding:14px;">
            ...
            <div id="nonaktif-count" class="mini-stat-val" style="font-size:28px;color:var(--amber);">
              <?= $dataNonaktif['total']; ?>
            </div>
          </div>
          ...
          <div class="stat-card" style="padding:14px;">
            ...
            <div id="rata-harga" class="mini-stat-val" style="font-size:22px;color:var(--dark);">
      ...
      <div id="section-booking" style="display:none;">
        ...
        <div class="filter-bar">
          ...
          <div class="search-input-wrap">
            <i class="ti ti-search"></i>
            <input type="text" id="search-booking" placeholder="Cari booking, nama user...">
          </div>

          <select class="form-input select-status" id="filter-status">
          ...
          <select class="form-input select-field" id="filter-lapangan">
          ...
          <input type="date" class="form-input input-date" id="filter-tanggal">
        </div>
                    ...
                    <td>
                      <?php if ($booking['status'] == 'tertunda'): ?>
                        <div class="booking-table-actions">
                          <a href="konfirmasi-booking.php?id=<?= $booking['booking_id']; ?>" class="btn btn-primary btn-sm">
                            Konfirmasi
                          </a>

                          <a href="tolak-booking.php?id=<?= $booking['booking_id']; ?>"
                            class="btn btn-outline btn-sm btn-red">
                            Batalkan
                          </a>
                        </div>
      ...
      <div id="section-jadwal" style="display:none;">
        ...
        <div class="flex-between">
          ...
          <div class="jadwal-filter">
            ...
            <select id="field-filter" onchange="gantiLapangan(this.value)">
        ...
        ");
              ...
              while ($f = mysqli_fetch_assoc($qField)) {
                ...
                <option value="<?= $f['field_id']; ?>" <?= (isset($_GET['field']) && $_GET['field'] == $f['field_id']) ? 'selected' : ''; ?>>
          ...
          <div class="flex-between">
            <div class="lapangan-selector">
              ...
              while ($field = mysqli_fetch_assoc($queryFields)):
                ...
                <div class="lapangan-pill <?= $aktif ? 'active' : ''; ?>" onclick="selectJadwalLapangan(this)">
            ...
            <div class="jadwal-nav">
              <a href="dashboard-owner.php?week=<?= $week - 1; ?>" class="btn btn-outline btn-sm">
        ...
        <div class="legend">
          <div class="legend-item">
            <div class="legend-dot booked"></div> Terpesan
          </div>
          <div class="legend-item">
            <div class="legend-dot available"></div> Tersedia
          </div>
          <div class="legend-item">
            <div class="legend-dot blocked"></div> Libur
          </div>
          ...
          <div class="schedule-grid">
            ...
            for ($jam = $jamMulai; $jam < $jamSelesai; $jam += $durasi) {
              ...
              for ($i = 0; $i < 7; $i++) {
                ...
                <div class="schedule-slot <?= $statusSlot; ?>" title="<?=
                    $statusSlot == 'available'
                    ? 'Tersedia'
                    : ($statusSlot == 'booked'
                      ? 'Terbooking'
            ...
            <div class="card card-no-mb">
              ...
              <div class="card-body">
                <div class="form-group form-group-sm">
                  ...
                  <input type="time" name="jam_buka" class="form-input" value="<?= $jam_buka; ?>">
                </div>

                <div class="form-group form-group-sm">
                  <label class="form-label">Jam Tutup</label>
                  <input type="time" name="jam_tutup" class="form-input" value="<?= $jam_tutup; ?>">
                </div>
                ...
                <div class="form-group form-group-last">
                  ...
                  <select name="durasi_slot" class="form-input">
                    <option value="1" <?= (($info['durasi_slot'] ?? 1) == 1) ? 'selected' : ''; ?>>
                      1 Jam
                    </option>

                    <option value="2" <?= (($info['durasi_slot'] ?? 1) == 2) ? 'selected' : ''; ?>>
                      2 Jam
                    </option>
                  </select>
                </div>
            ...
            <div class="card card-no-mb">
              ...
              <div class="card-body">
                <div class="form-group form-group-sm">
                  ...
                  <input type="date" name="tanggal_mulai" class="form-input" value="<?= $tanggal_mulai; ?>">
                </div>
                ...
                <div class="form-group form-group-sm">
                  ...
                  <input type="date" name="tanggal_selesai" class="form-input" value="<?= $tanggal_selesai; ?>">
                </div>
          ...
          <div class="setting-card">
            ...
            <form action="update-password-owner.php" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="password" name="konfirmasi_password" class="form-input" placeholder="Ulangi password baru"
                  required>
              </div>
  ...
  <div class="modal-overlay" id="add-modal">
    <div class="modal-box">
      <form action="add-field.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" id="add-id" name="field_id">

        <div class="form-group">
          <label class="form-label"> Nama Lapangan </label>
          <input type="text" class="form-input" id="new-nama" name="nama_lapangan" required>
        </div>

        <div class="form-group">
          <label class="form-label">Jenis Olahraga</label>
          <select class="form-input" id="new-jenis" name="jenis" required onchange="handleJenisChange(this)">
          ...
          <input type="text" class="form-input" id="new-jenis-lainnya" placeholder="Ketik jenis olahraga lain"
            style="display:none;margin-top:8px;">
        </div>

        <div class="form-group">
          <label class="form-label">Lokasi</label>
          <input type="text" class="form-input" id="new-lokasi" name="lokasi" required>
        </div>

        <div class="grid-2col-sm">
          <div class="form-group">
            <label class="form-label">Harga / Jam</label>
            <input type="number" class="form-input" id="new-harga" name="harga" equired>
          </div>

          <div class="form-group">
            <label class="form-label">Kapasitas</label>
            <input type="number" class="form-input" id="new-kapasitas" name="kapasitas" placeholder="10">
          </div>
        </div>

        <div class="form-group">
          <label class="form-label">Jenis Lantai</label>
          <input type="text" class="form-input" id="new-lantai" name="jenis_lantai">
        </div>

        <div class="form-group">
          <label class="form-label">Jam Operasional</label>
          <input type="text" class="form-input" id="new-jam" name="jam_operasional" placeholder="08:00 - 22:00">
        </div>

        <div class="form-group">
          <label class="form-label">Deskripsi</label>
          <textarea class="form-input" rows="3" name="deskripsi">
                </textarea>
        </div>

        <div class="form-group">
          <label class="form-label">Fasilitas</label>
          <input type="text" class="form-input" id="new-fasilitas" name="fasilitas"
        ...
        <div class="form-group">
          ...
          <input type="file" class="form-input" id="new-gambar" name="gambar" accept="image/*" required>

          <div id="preview-container" style="display:none; margin-top:12px;">
            <img id="preview-image" src="" alt="Preview" style="
                      width:100%;
                      max-width:260px;
                      height:170px;
                      object-fit:cover;
  ...
  <div class="modal-overlay" id="edit-modal">
    ...
    <div class="modal-box">
      <form action="update-field.php" method="POST" enctype="multipart/form-data">

        <input type="hidden" id="edit-id" name="field_id">
        ...
        <div class="form-group">
          <label class="form-label">Nama Lapangan</label>
          <input type="text" class="form-input" id="edit-nama" name="nama_lapangan">
        </div>

        <div class="form-group">
          <label class="form-label">Jenis Olahraga</label>
          <select class="form-input" id="edit-jenis" name="jenis" onchange="handleJenisChange(this)">
            <option value="Futsal">Futsal</option>
            <option value="Badminton">Badminton</option>
            <option value="Basket">Basket</option>
            <option value="Renang">Renang</option>
          ...
          <input type="text" class="form-input" id="edit-jenis-lainnya" placeholder="Ketik jenis olahraga lain"
            style="display:none;margin-top:8px;">
        </div>

        <div class="form-group">
          <label class="form-label">Lokasi</label>
          <input type="text" class="form-input" id="edit-lokasi" name="lokasi" required>
        </div>

        <div class="grid-2col-sm">
          <div class="form-group">
            <label class="form-label">Harga per Jam (Rp)</label>
            <input type="number" class="form-input" id="edit-harga" name="harga">
          </div>

          <div class="form-group">
            <label class="form-label">Kapasitas</label>
            <input type="number" class="form-input" id="edit-kapasitas" name="kapasitas" placeholder="10">
          </div>
        </div>

        <div class="form-group">
          <label class="form-label">Jenis Lantai</label>
          <input type="text" class="form-input" id="edit-lantai" name="jenis_lantai">
        </div>

        <div class="form-group">
          <label class="form-label">Jam Operasional</label>
          <input type="text" class="form-input" id="edit-jam" name="jam_operasional" placeholder="08:00 - 22:00">
        </div>

        <div class="form-group">
          <label class="form-label">Deskripsi</label>
          <textarea class="form-input" id="edit-deskripsi" name="deskripsi" rows="3"></textarea>
        </div>

        <div class="form-group">
          <label class="form-label">Fasilitas</label>
          <input type="text" class="form-input" id="edit-fasilitas" name="fasilitas"
            placeholder="cth: Parkir, Kantin, Toilet">
        </div>
        ...
        <div class="form-group">
          ...
          <div id="edit-preview-container">
            <img id="edit-preview-image" style="
            width:220px;
            height:150px;
            object-fit:cover;
            border-radius:12px;
        ...
        <div class="form-group">
          ...
          <input type="file" class="form-input" id="edit-gambar" name="gambar" accept="image/*">
        </div>
