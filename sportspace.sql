...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2026 at 11:17 AM
...
INSERT INTO `fields` (`field_id`, `nama_lapangan`, `jenis`, `harga`, `status`) VALUES
(1, 'Lapangan Futsal A - GOR Maju Jaya', 'Futsal', 80000.00, 'tersedia'),
(2, 'Arena Badminton 88', 'Badminton', 45000.00, 'tersedia'),
(3, 'Basket Court Pro', 'Basket', 120000.00, 'penuh'),
(4, 'GOR Sport Center', 'Futsal', 70000.00, 'tersedia');
